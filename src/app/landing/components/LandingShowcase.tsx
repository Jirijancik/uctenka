            ...
            <div className="relative container py-8 md:py-12 xl:py-16 2xl:py-24">
                <div className="relative z-10 grid gap-12 lg:grid-cols-7 lg:gap-24">
                    ...
                    <div className="relative lg:col-span-4">
                        <div
                            className="absolute -start-50 -top-50 z-[-1] size-[450px] bg-cover bg-center bg-no-repeat opacity-20 sm:size-[600px] dark:hidden"
                            style={{ backgroundImage: `url(/images/landing/showcase-bg-gradient.png)` }}></div>
                        <div
                            className="absolute -end-12 -bottom-12 z-[-1] size-[350px] bg-cover bg-center bg-no-repeat opacity-60 max-lg:hidden sm:size-[120px] dark:opacity-60"
                            style={{ backgroundImage: `url(/images/landing/showcase-bg-element.png)` }}></div>
