                ...
                <div className="max-w-4xl">
                    ...
                    <div className="card bg-base-100 card-border mt-6">
                        <div className="card-body p-3">
                            <textarea
                                className="textarea m-0 h-24 w-full resize-none border-0 p-0 text-base focus:outline-none"
                            ...
                            <div className="mt-2 flex items-end justify-between">
                                ...
                                <div className="text-base-content/60 flex items-center text-xs font-medium">
                                ...
                                <div className="flex items-center gap-2">
                                    <button className="btn btn-sm btn-outline border-base-300 rounded-full">
