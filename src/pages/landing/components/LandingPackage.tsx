        ...
        <div className="container py-8 md:py-12 xl:py-16 2xl:py-24">
            <div className="text-center">
                ...
                <p className="text-base-content/70 mt-3 inline-block max-w-lg">
                    ...
                    <span
                        ...
                        data-tip="Pay once for lifetime access, enjoy free updates, and upgrade to a higher plan anytime with a discount on your current plan">
                        <span className="decoration-primary pb-0.5 underline decoration-dashed decoration-1 underline-offset-2">
                            <span className="animated-text from-primary mx-1 bg-linear-to-r via-blue-500 to-purple-500 font-medium">
                                one time payment
                            </span>
                        </span>
                    </span>
                    plan that fits your needs, with lifetime access and upgrade it anytime.
                </p>
            </div>
            <div className="mt-16 grid gap-4 lg:grid-cols-3 xl:gap-6">
                ...
                <div className="border-primary/25 rounded-box relative border">
                    ...
                    <div className="bg-primary/4 dark:bg-primary/6 border-primary/20 border-b p-6">
                        ...
                        <Link className="btn btn-primary btn-block mt-5 gap-2.5" to={purchaseLink} target="_blank">
                ...
                <div className="border-secondary/25 rounded-box border">
                    <div className="bg-secondary/4 dark:bg-secondary/6 border-secondary/20 border-b p-6">
                        ...
                        <Link className="btn btn-secondary btn-block mt-5 gap-2.5" to={purchaseLink} target="_blank">
            ...
            <div>
                <p className="mt-3">
                    ...
                    <Link to="/docs/knowledge/packages" className="text-primary ms-1" target="_blank">
                        Packages
                    </Link>
                </p>
            </div>
